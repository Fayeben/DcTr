...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    print("alexnet total parameters. ",model_total_params)

    test = torch.randn(1, 2048, 3).to(args.local_rank)
    flops = FlopCountAnalysis(base_model, test)
